...
import { ExportedIAOEventEntity } from 'src/entity/create-iao-event.entity';
...
export class IaoEventBuilderService {
  ...
  async createIAOEvent(
    ...
    return {
      ...
      soldAmountByFiat: 0,
      participatedByFiatAmount: 0,
      fiatSymbol: createIaoEventDto.fiatSymbol,
      fiatLogoUrl: FIAT_CURRENCY_LOGO[createIaoEventDto.fiatSymbol],
      notificationStatus: {
        isWhitelistAnnounced: false,
        isIaoEventFailedAnnounced: false,
        isIaoEventSucceededAnnounced: false,
        isParticipationStartAnnounced: false,
      },
      revenue: {
      ...
      allowStraits: createIaoEventDto.allowStraits,
      allowWhitelist: createIaoEventDto.allowWhitelist,
      nftPriceSgd: createIaoEventDto.nftPriceSgd
    };
  }
  ...
  getIaoEventDetail(iaoEvent: any, fnft: any, iaoRequest: any, obj: any) {
    return {
      ...
      allowStraits: iaoEvent.allowStraits,
      nftPriceSgd: iaoEvent.nftPriceSgd,
      fiatSymbol: iaoEvent.fiatSymbol,
      ...
      allowWhitelist: iaoEvent.allowWhitelist,
  ...
  updateIaoEventDetail(iaoEvent: UpdateIaoEventDto, user: any) {
    return {
      ...
      nftPriceSgd: iaoEvent.nftPriceSgd,
      fiatSymbol: iaoEvent.fiatSymbol,
      fiatLogoUrl: FIAT_CURRENCY_LOGO[iaoEvent.fiatSymbol],
      percentageOffered: iaoEvent.percentageOffered,
      vaultUnlockThreshold: iaoEvent.vaultUnlockThreshold,
      eventPhotoUrl: iaoEvent.eventPhotoUrl,
      eventBannerUrl: iaoEvent.eventBannerUrl,
  ...
  convertExportedEvents(data: any[], assetTypes: any[]) {
    const exportedEvents: ExportedIAOEventEntity[] = data.map((event) => {
      ...
      return {
        ...
        vaultUnlockThresholdToken: event.vaultUnlockThreshold
