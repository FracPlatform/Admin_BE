...
export class DexAdminController {
  ...
  @Put('admin/pair/:id')
  async deletePair(@Param('id') id: string, @Body() data: DeletePairDto) {
    return this.dexAdminService.deletePair(id, data);
  }
  ...
  @Get('admin/tiers')
  async getTiers(@Query() filter: GetTiersDto) {
    return await this.dexAdminService.getTiers(filter);
  }
  ...
  async addTier(
    ...
    @Body() data: CreateTiersDto,
  ) {
    return await this.dexAdminService.createTier(file, data);
  }

  @Get('admin/tiers/:id')
  async getTierDetail(@Param('id') id: string) {
    return await this.dexAdminService.getTierDetail(id);
  }
  ...
  async updateTier(
    ...
    return await this.dexAdminService.updateTier(id, file, data);
  }

  @Delete('admin/tiers/:id')
  async deleteTier(@Param('id') id: string) {
    return await this.dexAdminService.deleteTier(id);
  }
}
